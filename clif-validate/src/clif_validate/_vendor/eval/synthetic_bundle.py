...
def build_synthetic_site(site_dir: str | Path, *, n_stays: int = 24,
    ...
    from clif_validate._vendor.data.cohort import build_cohort
    from clif_validate._vendor.data.splits import content_manifest
...
def build_synthetic_bundle(bundle_dir: str | Path, site_dir: str | Path,
    ...
    from clif_validate._vendor.data.tokenize import tokenize_site
    from clif_validate._vendor.eval.bundle import write_bundle_manifest
