...
At ~30M on data-constrained Site 1 (utility saturates ~28M, arXiv:2505.22964), unfreezing risks catastrophic
...
*Measured on the development site:* the model builds at **34.9M params**; frozen arm = **0.7M
