...
def load_embeddings(cache_path: Path, data_path: Path, label_column: str = "label_home") -> tuple[np.ndarray, np.ndarray]:
    """
    ...
    Args:
        ...
        label_column: Name of label column in data file (default: "label_home" for Task1)
...
def main():
    ...
    if args.output_dir is None:
        results_writer = get_results_writer(
            task_name="task1-discharged-home",
    ...
    if is_main_process():
        ...
        try:
            ...
            train_embeddings, train_labels = load_embeddings(
                train_cache_path,
                train_data_path,
                label_column="label_home"  # Task1: Discharged Home
            )
