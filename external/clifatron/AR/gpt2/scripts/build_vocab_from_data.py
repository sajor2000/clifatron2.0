#!/usr/bin/env python3
"""
build_vocab_from_data.py - Build Vocabulary from Parquet Data for GPT2
...
Usage:
    python AR/gpt2/scripts/build_vocab_from_data.py
"""
...
def build_vocabulary(
    ...
    # Tier 1: Special tokens (5) - Using gpt2_hf style with brackets
...
def main():
    ...
    # Output paths
    output_paths = [
        root_dir / "models" / "gpt2" / "vocab_lock.json",  # Central location
        root_dir / "AR" / "gpt2" / "vocab_lock.json",      # Local lock
    ]
